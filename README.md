...
[![Continuous Integration](https://github.com/Sensible-Analytics/rentroo/actions/workflows/ci.yml/badge.svg?event=push)](https://github.com/Sensible-Analytics/rentroo/actions/workflows/ci.yml)
...
1. Go to the [Releases page](https://github.com/Sensible-Analytics/rentroo/releases).
...
curl https://raw.githubusercontent.com/rentroo/rentroo/master/.env.domain > .env
```
