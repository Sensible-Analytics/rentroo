![Docker](https://github.com/rentroo/emailer/workflows/Docker/badge.svg)

# emailer

Generates and sends emails.
This service is part of the MicroRealEstate application more [here](https://github.com/rentroo/rentroo/blob/master/README.md).
